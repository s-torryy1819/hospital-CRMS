...
public class MainController {
    ...
    public ModelAndView getIndex() {
        ...
        Patient patient4 = new Patient("Mark", "Becker", 1998, "Basilikumweg 53", "03552353442", "Ackerweg 88", true,
                null, 4);
        Patient patient5 = new Patient("Anton", "Wagner", 2000, "Baumannstrasse 34", "06536662323", "Am Fuchsbau 90",
                false, null, 5);
        Patient patient6 = new Patient("Chris", "Fischer", 2001, "Ackerweg 65", "07467546344", "Am Grund 1", true,
                "Cardiovascular", 6);
        Patient patient7 = new Patient("Paul", "Schmidt", 1975, "Baumschulenweg 76", "05363452232", "Gundorferteich 15",
                false, null, 7);
        Patient patient8 = new Patient("Robert", "Schulz", 1986, "Adenauerallee 4", "06756453433", "Am Wolfswinkel 16",
                true, "Cardiovascular", 8);
        Patient patient9 = new Patient("Christiana", "Meier", 2003, "Am Wolfswinkel 75", "05363123232", "Ackerweg 1",
                false, null, 9);
        ...
        // VISITS
        Visit visit1 = new Visit(LocalDate.parse("2023-12-01"), "Arenavirus", "Cure the virus", practicioner, cabinet5,
                patient1);
        Visit visit2 = new Visit(LocalDate.parse("2023-11-15"), "Hepatitis A", "Diagnose the disease", practicioner,
                cabinet5,
                patient2);
        Visit visit3 = new Visit(LocalDate.parse("2023-11-22"), "Infection", "Cure the disease", gynecologist, cabinet7,
                patient3);
        Visit visit4 = new Visit(LocalDate.parse("2023-11-20"), "Influenza in humans, pandemic", "Cure the virus",
                practicioner,
                cabinet4,
                patient4);
        ...
        Visit visit6 = new Visit(LocalDate.parse("2023-11-11"), "Cataracts", "Make analysis for a surgery",
                ...
                patient6);
        Visit visit7 = new Visit(LocalDate.parse("2023-11-12"), "Epilepsy", "Regular check", neurologist, cabinet4,
                patient7);
        Visit visit8 = new Visit(LocalDate.parse("2023-11-29"), "Dry Eye", "Set date for a surgery", ophthalmologist,
                cabinet6,
                patient8);
        Visit visit9 = new Visit(LocalDate.parse("2023-12-17"), "Cerebral Aneurysm", "Regular check", medical_eneticist,
                cabinet3,
                patient9);
        Visit visit10 = new Visit(LocalDate.parse("2023-12-10"), "Cystic fibrosis", "Cure the virus", gynecologist,
                cabinet7,
                patient10);
        ...
        Medicine medicine2 = new Medicine("Alendronic acid",
                "Bisphosponates are prescribed to help your bones stay as strong as possible", 8, 345, false);
        Medicine medicine3 = new Medicine("Citalopram",
                "Citalopram is a type of antidepressant known as a selective serotonin reuptake inhibitor (SSRI)", 23,
                1020, true);
        ...
        HealthProcedure procedure6 = new HealthProcedure("Ophthalmology analyse", cabinet6, 680, ophthalmologist);
        HealthProcedure procedure7 = new HealthProcedure("Gynecology visit", cabinet7, 950, gynecologist);
        HealthProcedure procedure8 = new HealthProcedure("Oncological recovery check", cabinet8, 500, oncologist);
        HealthProcedure procedure9 = new HealthProcedure("Endoscopy", cabinet5, 375, practicioner);
        HealthProcedure procedure10 = new HealthProcedure("Neurological check for child", cabinet10, 600, neurologist);
